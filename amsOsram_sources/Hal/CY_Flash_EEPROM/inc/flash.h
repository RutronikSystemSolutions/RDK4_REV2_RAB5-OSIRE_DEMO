...
#ifndef AMSOSRAM_SOURCES_HAL_CY_FLASH_EEPROM_INC_FLASH_H_
#define AMSOSRAM_SOURCES_HAL_CY_FLASH_EEPROM_INC_FLASH_H_
...
#endif /* AMSOSRAM_SOURCES_HAL_CY_FLASH_EEPROM_INC_FLASH_H_ */
